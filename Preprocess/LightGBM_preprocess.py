...
# drop cols
train.drop(columns=['id', 'base_date', 'height_restricted', 'vehicle_restricted'], inplace=True)
test.drop(columns=['id', 'base_date', 'height_restricted', 'vehicle_restricted'], inplace=True)
