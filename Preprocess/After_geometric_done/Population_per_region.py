...
for indexx, region in enumerate(jeju_list):
    ...
    train.loc[(train['year'] == 2021) & (train['start_region_1'] == '제주시') & (train['end_region_3'] == region), 'population_dong2'] = jeju_2021['인구'][indexx]
    train.loc[(train['year'] == 2021) & (train['start_region_1'] == '제주시') & (train['end_region_2'] == region), 'population_dong2'] = jeju_2021['인구'][indexx]
    # 제주시-2022년
    ...
    train.loc[(train['year'] == 2022) & (train['start_region_1'] == '제주시') & (train['end_region_3'] == region), 'population_dong2'] = jeju_2021['인구2'][indexx]
    train.loc[(train['year'] == 2022) & (train['start_region_1'] == '제주시') & (train['end_region_2'] == region), 'population_dong2'] = jeju_2021['인구2'][indexx]
...
for indexxx, region in enumerate(jeju_list):
    ...
    test.loc[(test['year'] == 2021) & (test['start_region_1'] == '제주시') & (test['end_region_3'] == region), 'population_dong2'] = jeju_2021['인구'][indexxx]
    test.loc[(test['year'] == 2021) & (test['start_region_1'] == '제주시') & (test['end_region_2'] == region), 'population_dong2'] = jeju_2021['인구'][indexxx]
    # 제주시-2022년
    ...
    test.loc[(test['year'] == 2022) & (test['start_region_1'] == '제주시') & (test['end_region_3'] == region), 'population_dong2'] = jeju_2021['인구2'][indexxx]
    test.loc[(test['year'] == 2022) & (test['start_region_1'] == '제주시') & (test['end_region_2'] == region), 'population_dong2'] = jeju_2021['인구2'][indexxx]
print('제주시 인구 매핑 끝')
...
for indexx, region in enumerate(west_list):
    ...
    train.loc[(train['year'] == 2021) & (train['start_region_1'] == '서귀포시') & (train['end_region_2'] == region), 'population_dong2'] = west_2021['인구'][indexx]
    train.loc[(train['year'] == 2021) & (train['start_region_1'] == '서귀포시') & (train['end_region_3'] == region), 'population_dong2'] = west_2021['인구'][indexx]
    # 제주시-2022년
    ...
    train.loc[(train['year'] == 2022) & (train['start_region_1'] == '서귀포시') & (train['end_region_2'] == region), 'population_dong2'] = west_2021['인구2'][indexx]
    train.loc[(train['year'] == 2022) & (train['start_region_1'] == '서귀포시') & (train['end_region_3'] == region), 'population_dong2'] = west_2021['인구2'][indexx]
